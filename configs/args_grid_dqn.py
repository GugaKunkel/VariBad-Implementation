...
def get_args(rest_args):
    ...
    parser.add_argument('--log_interval', type=int, default=20000, help='log interval, one log per n updates')
    ...
    parser.add_argument('--vis_interval', type=int, default=20000, help='visualisation interval, one eval per n updates')
